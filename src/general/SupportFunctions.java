...
public class SupportFunctions {
	 ...
	 * @throws ExtensionException
	 */
	public static void addToRegistry(FuzzySet f, String name)
			throws ExtensionException {
		...
		// If the label is already registered just overide it.
			if (registry.containsKey(name)) {
				...
				registry.put(name, f);
				org.nlogo.swing.MessageDialog.show("Warning", "There was one or more labels already registered and the previuos entries have been overided");
			} else {
				registry.put(name, f);
			}
	}
