...
import sets.general.OperatorSet;
...
public class NotSet extends OperatorSet {
	 ...
	 * 
	 * @see sets.general.OperatorSet#OperatorSet(String, List, boolean, String,
	 *      double[])
	 */
	public NotSet(List<FuzzySet> params, boolean continuous, String label,
			double[] universe) {
		super("Not-Set", params, continuous, label, universe);
	}
