...
public abstract class OperatorSet extends FuzzySet {
	 ...
	 * @see sets.general.FuzzySet#FuzzySet(String description, boolean continuous,
	 *      String label,double[] universe).
	 */
	public OperatorSet(String description, List<FuzzySet> params, boolean continuous,
			String label, double[] universe) {
